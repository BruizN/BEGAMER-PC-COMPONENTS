...
## Justificación
1. **Estructura de datos flexible:** En redis se pueden usar Hashes para representar el carrito, donde la clave puede ser el token o un header de usuario y los campos aaaasaon los productos con sus cantidades, esto permite actualizaciones atomicas sencillas.
